defmodule BcitWeb.StudentControllerTest do
  use BcitWeb.ConnCase

  import Bcit.SchoolFixtures

  @create_attrs %{sid: "some sid", firstname: "some firstname", lastname: "some lastname", score: 42}
  ...
  describe "update student" do
    ...
    test "redirects when data is valid", %{conn: conn, student: student} do
      ...
      assert html_response(conn, 200) =~ "some updated sid"
    end
